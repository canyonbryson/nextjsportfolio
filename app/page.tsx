...
export default function Home() {
  ...
  return (
    <div className="z-10 flex flex-col items-center p-0">
      <Image
        ...
        alt="me"
      />
      <h1 className="text-dark100_light900 h1-bold z-10 mt-10">
        Portfolio Overview
      </h1>
      ...
      {/* <div className="z-0 hidden size-4/5 dark:fixed">
        <div className="size-full bg-black opacity-95">
