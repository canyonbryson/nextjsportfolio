...
const Footer = () => {
  return (
    <nav className="flex-center md:flex-between background-light900_dark200 fixed bottom-0 z-20 w-full border-t-2 border-gray-200 p-2 shadow-light-400 dark:border-gray-800 dark:shadow-none sm:px-12">
